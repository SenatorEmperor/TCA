# Terminal Chat Application (TCA) by [Ramazan Kamilov]

This is an End-to-End encrypted Terminal-Chat-Application (TCA) by [Ramazan Kamilov]. 
...
ALL THE INFORMATION BELOW SHOULD BE RECEIVED BY THE PERSON WHO STARTS SERVER 
...
DON'T FORGET TO SEND NECESSARY INFORMATION SUCH AS PORT AND NGROK LINK (if needed) TO CLIENT
